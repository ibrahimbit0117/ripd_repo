        ...
        <div>
            <form method="POST" onsubmit="" name="" action="cheque_make_out.php">	
                <table  class="formstyle" style="font-family: SolaimanLipi !important;">          
                    <tr><th colspan="2" style="text-align: center;">চাকুরি স্থগিতকরন</th></tr>
                    <tr>
                        <td>
                            <div style="font-family: SolaimanLipi !important;height: 250px;">
                                <div id="left" style="border: 1px solid black; width: 49%; float: left;height: 100%">
                                    ...
                                    <div id="bottom" style="padding: 5px;">
                                        <b>কারন &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b> <input class="box" type="text" name="emp_search"/></br></br>
                                        <b>তারিখ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b> <input class="box" type="text" id="date" placeholder="Date" name="date" value=""/></br></br>
                                        <b>বর্ণনা &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b> <input class="box" type="text" name="emp_search"/></br></br>
                                        <b>স্ক্যান ডকুমেন্ট &nbsp;:</b><input type="file" name="emp_search"/>
                                    </div>
                                </div>
                                <div id="ri8" style="border: 1px solid black; width: 49%; float: left;height: 100%">
