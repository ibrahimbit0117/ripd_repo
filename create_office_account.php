...
<div class="columnSld" style=" padding-left: 10px;">
    <div class="main_text_box">
        ...
        <div>           
            <form style="padding-right: 20px;" method="POST" enctype="multipart/form-data" action="" id="off_form" name="off_form">
                
                <table class="formstyle"  style=" width: 110%; ">          
                    ...
                    <tr>
                        <td colspan="2">অফিস সিলেক্ট করুন <input  class ="textfield" type="radio" checked = "checked" id="sales_name" name="sales_name" value ="রিপড অফিস"/>রিপড অফিস <input  class ="textfield" type="radio" id="sales_name" name="sales_name" value ="পাওয়ারস্টোর অফিস"/> পাওয়ারস্টোর অফিস</td>
                    </tr>
                    <tr>
                        <td>পাওয়ারস্টোর সিলেক্ট করুন</td>
                        <td>:    
                    ...
                    <tr>
                        ...
                        <td>:    
                            <select class="box2" name="off_type" id="off_type">
                                <option value="all">-সিলেক্ট করুন-</option> 
                                <option value="ripd">রিপড হেড অফিস</option>
