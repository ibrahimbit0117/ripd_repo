    ...
    <div class="main_text_box">
        ...
        <div>           
            <form method="POST" onsubmit="">	
                <table class="formstyle"  style=" width: 600px; ">          
                    <tr><th style="text-align: center" colspan="3"><h1>আপডেট প্রোডাক্ট ইন্ট্রিডিউসিং</h1>
                    </th>
                    </tr>
                    <tr><td colspan="3"></td>
                    </tr>                    
                    <tr>
                        <td >সিলেক্ট প্রোডাক্ট চার্ট</td>
                        <td><select class="box" name="transfer_to" style="width: 150px;">
                                <option value="">রিপড চার্ট</option>
                                <option value="">পাওয়ার স্টোর চার্ট</option>
                            </select>                            
                        </td>       
                        <td></td>
                    </tr>
                    ...
                    <tr>
                        <td>ইনফরমেশন ইন</td>
                        <td style="padding-left: 0px"><textarea id="cause" name="cause" ></textarea></td>
                    </tr>
                        <tr>
                        <td >প্রোডাক্টের ছবি </td> 
                        <td><input class="filefield" type="file" id="product_picture" name="product_picture" /> </td>
                    </tr>
                    <tr>                    
